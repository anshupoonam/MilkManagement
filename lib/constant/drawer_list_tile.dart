...
import 'package:milkmanagement/pages/image_upload_new.dart';
...
import 'package:milkmanagement/pages/share_market_company_details.dart';
...
import 'package:milkmanagement/pages/video_conf.dart';
...
Widget DrawerList(BuildContext context) {
  return ListView(
    ...
    children: <Widget>[
      ...
      ListTile(
        leading: const Icon(Icons.save),
        title: const Text("Share Market"),
        onTap: () {
          Get.to(() => const ShareMarketDetails());
        },
      ),
      ListTile(
        leading: const Icon(Icons.save),
      ...
      ListTile(
        ...
        ListTile(
        leading: const Icon(Icons.save),
        title: const Text("Image Upload New"),
        onTap: () {
          Get.to(() => const ImageUploadNew());
        },
      ),
      ListTile(
        leading: const Icon(Icons.video_call),
        title: const Text("Video Confrenceing"),
        onTap: () {
          Get.to(() => const VideoConfrenceing());
        },
      ),
      ListTile(
